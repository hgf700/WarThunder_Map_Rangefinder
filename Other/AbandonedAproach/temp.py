...
class SettingsManager:
    ...
    @staticmethod
    def get_bounding_box(scale: float = Config.SCALE) -> Tuple[int, int, int, int]:
...
class ClickOverlay(QtWidgets.QWidget):
    def __init__(self):
        ...
        print(f"Overlay aktywny: klikaj w [{self.min_x}, {self.min_y}] → [{self.max_x}, {self.max_y}]")
...
if __name__ == "__main__":
    ...
    overlay.show()
    print("Klikaj w ekran – współrzędne zapisują się w settings/click_position.txt")
    sys.exit(app.exec_())